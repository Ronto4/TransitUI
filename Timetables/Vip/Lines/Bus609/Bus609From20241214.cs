...
public class Bus609From20241214 : Bus609Base<Bus609From20241214>, IBus609Base<Bus609From20241214>, ILineInstance
{
    ...
    public Line Line { get; } = new()
    {
        ...
        MainRouteIndices = [RouteIndex(Routes.SatzkornJungfernsee)],
        ...
        [
            ...
            new Line.TripCreate
            {
                RouteIndex = RouteIndex(Routes.SatzkornJungfernsee),
                TimeProfileIndex = 1,
                DaysOfOperation = DaysOfOperation.Monday | DaysOfOperation.Tuesday | DaysOfOperation.Wednesday | DaysOfOperation.Thursday,
